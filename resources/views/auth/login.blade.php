        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input id="email" name="email" type="text" placeholder="Email de Registro"
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remeber" /> <label class="text-gray-500 text-sm">Mantener mi sesion abierta</label>
                </div>
